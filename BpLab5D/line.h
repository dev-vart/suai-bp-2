...
Line::Line(const Line& source) : _a(source._a), _b(source._b) {}

void Line::draw(Screen* screen) const { screen->putLine(_a.getY(), _a.getX(), _b.getY(), _b.getX()); }
...
Point Line::getFirstPoint() const { return _a; }

Point Line::getSecondPoint() const { return _b; }
